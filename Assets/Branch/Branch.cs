...
public class Branch : MonoBehaviour {
    ...
    internal static void getShortURL(object universalObject, object linkProperties, Action<string, string> p)
    {
    ...
    internal static void shareLink(object universalObject, object linkProperties, string v, Action<Dictionary<string, object>, string> p)
    {
        throw new NotImplementedException();
    }
